//
//  GenesisThemePickerView.swift
//  GameEmulator
//
//  Theme selection UI for Genesis controller
//  DEBUG BUILD ONLY
//
...
struct GenesisThemePickerView: View {
    @Environment(\.dismiss) private var dismiss
    @ObservedObject var themeManager: GenesisThemeManager
...
private struct NESThemeCard: View {
...
#Preview {
    GenesisThemePickerView(themeManager: GenesisThemeManager())
}
