...
//  GameEmulator
//
//  D-Pad component for NES controller
//

import SwiftUI

struct NESDPadView: View {
    let layout: NESControllerLayout.DPadLayout
    ...
    private func calculateDPadButtons(at point: CGPoint, in frame: CGRect) -> [NESButtonType] {
