...
//  GameEmulator
//
//  Theme configuration for GBA controller appearance
//

import Foundation

struct GBAControllerTheme: Codable, Identifiable, Equatable {
    let id: String
    let name: String
    ...
    static let defaultTheme = GBAControllerTheme(
        id: "default",
        name: "Theme 1",
    ...
    static let theme2 = GBAControllerTheme(
        id: "theme2",
        name: "Theme 2",
    ...
    static let theme3 = GBAControllerTheme(
        id: "theme3",
        name: "Theme 3",
    ...
    static let theme4 = GBAControllerTheme(
        id: "theme4",
        name: "Theme 4",
    ...
    static let theme5 = GBAControllerTheme(
        id: "theme5",
        name: "Theme 5",
    ...
    static let allThemes: [GBAControllerTheme] = [
        defaultTheme,
        theme2,
        theme3,
        theme4,
